...
public:
    ...
    virtual int *get_rx_channel_fds(size_t &length) const = 0;
    ...
    virtual void post_dump_wqe(xlio_tis *tis, void *addr, uint32_t len, uint32_t lkey,
                               bool first) = 0;
    virtual bool credits_get(unsigned credits) = 0; // TODO Add id argument for bonding
...
#ifdef DEFINED_UTLS
    virtual bool tls_tx_supported(void) = 0;
    virtual bool tls_rx_supported(void) = 0;
