...
static void getit(struct json_object *new_obj, const char *field)
{
	...
	if (!doca_third_party_json_object_object_get_ex(new_obj, field, &o))
		printf("Field %s does not exist\n", field);

	enum json_type o_type = doca_third_party_json_object_get_type(o);
	printf("new_obj.%s json_object_get_type()=%s\n", field, doca_third_party_json_type_to_name(o_type));
	printf("new_obj.%s json_object_get_int()=%d\n", field, doca_third_party_json_object_get_int(o));
	printf("new_obj.%s json_object_get_int64()=%" PRId64 "\n", field, doca_third_party_json_object_get_int64(o));
	printf("new_obj.%s json_object_get_uint64()=%" PRIu64 "\n", field,
	       doca_third_party_json_object_get_uint64(o));
	printf("new_obj.%s json_object_get_boolean()=%d\n", field, doca_third_party_json_object_get_boolean(o));
	printf("new_obj.%s json_object_get_double()=%f\n", field, doca_third_party_json_object_get_double(o));
}

static void checktype_header(void)
{
	printf("json_object_is_type: %s,%s,%s,%s,%s,%s,%s\n", doca_third_party_json_type_to_name(json_type_null),
	       doca_third_party_json_type_to_name(json_type_boolean), doca_third_party_json_type_to_name(json_type_double),
	       doca_third_party_json_type_to_name(json_type_int), doca_third_party_json_type_to_name(json_type_object),
	       doca_third_party_json_type_to_name(json_type_array), doca_third_party_json_type_to_name(json_type_string));
}
static void checktype(struct json_object *new_obj, const char *field)
{
	struct json_object *o = new_obj;
	if (field && !doca_third_party_json_object_object_get_ex(new_obj, field, &o))
		printf("Field %s does not exist\n", field);

	printf("new_obj%s%-18s: %d,%d,%d,%d,%d,%d,%d\n", field ? "." : " ", field ? field : "",
	       doca_third_party_json_object_is_type(o, json_type_null), doca_third_party_json_object_is_type(o, json_type_boolean),
	       doca_third_party_json_object_is_type(o, json_type_double), doca_third_party_json_object_is_type(o, json_type_int),
	       doca_third_party_json_object_is_type(o, json_type_object), doca_third_party_json_object_is_type(o, json_type_array),
	       doca_third_party_json_object_is_type(o, json_type_string));
}
