 ...
 */
JSON_EXPORT size_t doca_third_party_json_tokener_get_parse_end(struct json_tokener *tok);
 ...
 */
JSON_EXPORT const char *doca_third_party_json_tokener_error_desc(enum json_tokener_error jerr);
 ...
 */
JSON_EXPORT enum json_tokener_error doca_third_party_json_tokener_get_error(struct json_tokener *tok);
 ...
 */
JSON_EXPORT struct json_tokener *doca_third_party_json_tokener_new(void);

/**
 * Allocate a new json_tokener with a custom max nesting depth.
 * @see JSON_TOKENER_DEFAULT_DEPTH
 */
JSON_EXPORT struct json_tokener *doca_third_party_json_tokener_new_ex(int depth);

/**
 * Free a json_tokener previously allocated with json_tokener_new().
 */
JSON_EXPORT void doca_third_party_json_tokener_free(struct json_tokener *tok);

/**
 * Reset the state of a json_tokener, to prepare to parse a
 * brand new JSON object.
 */
JSON_EXPORT void doca_third_party_json_tokener_reset(struct json_tokener *tok);
 ...
 */
JSON_EXPORT struct json_object *doca_third_party_json_tokener_parse(const char *str);
 ...
 * @see json_tokener_parse_ex()
 */
JSON_EXPORT struct json_object *doca_third_party_json_tokener_parse_verbose(const char *str,
                                                           enum json_tokener_error *error);

/**
 * Set flags that control how parsing will be done.
 */
JSON_EXPORT void doca_third_party_json_tokener_set_flags(struct json_tokener *tok, int flags);
 ...
 */
JSON_EXPORT struct json_object *doca_third_party_json_tokener_parse_ex(struct json_tokener *tok, const char *str,
                                                      int len);
