...
class xlio_ultra_api_socket_send_receive : public xlio_ultra_api_base {
public:
...
/**
 * @test xlio_ultra_api_socket_send_receive.ti_1
 * @brief
 *    Create TCP socket/connect/send(initiator)/receive(target)
 * @details
 */
TEST_F(xlio_ultra_api_socket_send_receive, ti_1)
{
    int rc;
    int pid = fork();
