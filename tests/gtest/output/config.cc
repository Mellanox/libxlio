...
TEST_F(output, config_ring_elements_count_warning)
{
    check_file("config-ring-elements-warning.json",
            ...
            "XLIO WARNING: performance.rings.tx.ring_elements_count=0 must be greater than "
            ...
            "XLIO WARNING: performance.rings.rx.ring_elements_count=0 must be greater than "
