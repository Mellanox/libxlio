...
protected:
    void SetUp() override
    {
        ...
        doca_third_party_json_object_object_add(simple_property, "type", doca_third_party_json_object_new_string("integer"));
        doca_third_party_json_object_object_add(simple_property, "title", doca_third_party_json_object_new_string("Test Property"));
        doca_third_party_json_object_object_add(simple_property, "description",
                               doca_third_party_json_object_new_string("A test property"));
        doca_third_party_json_object_object_add(simple_property, "default", doca_third_party_json_object_new_int(42));

        extended_property = doca_third_party_json_object_new_object();
        doca_third_party_json_object_object_add(extended_property, "type", doca_third_party_json_object_new_string("string"));
        doca_third_party_json_object_object_add(extended_property, "title", doca_third_party_json_object_new_string("Memory Size"));
        doca_third_party_json_object_object_add(extended_property, "description",
                               doca_third_party_json_object_new_string("A memory size property"));
        doca_third_party_json_object_object_add(extended_property, "x-memory-size", doca_third_party_json_object_new_boolean(true));
        ...
        doca_third_party_json_object_object_add(extended_string_option, "type", doca_third_party_json_object_new_string("string"));
        doca_third_party_json_object_object_add(extended_string_option, "pattern",
                               doca_third_party_json_object_new_string("^[0-9]+[KMGkmg]?[B]?$"));
        doca_third_party_json_object_object_add(extended_string_option, "default", doca_third_party_json_object_new_string("32MB"));
        json_object *extended_integer_option = doca_third_party_json_object_new_object();
        doca_third_party_json_object_object_add(extended_integer_option, "type", doca_third_party_json_object_new_string("integer"));
        doca_third_party_json_object_object_add(extended_integer_option, "default",
        ...
        doca_third_party_json_object_object_add(int_option, "type", doca_third_party_json_object_new_string("integer"));
        doca_third_party_json_object_object_add(int_option, "default", doca_third_party_json_object_new_int(1));
        ...
        doca_third_party_json_object_object_add(string_option, "type", doca_third_party_json_object_new_string("string"));
        doca_third_party_json_object_object_add(string_option, "default", doca_third_party_json_object_new_string("default_val"));
        ...
        doca_third_party_json_object_object_add(one_of_property, "title", doca_third_party_json_object_new_string("OneOf Property"));
        doca_third_party_json_object_object_add(one_of_property, "description",
                               doca_third_party_json_object_new_string("A oneOf property"));

        object_property = doca_third_party_json_object_new_object();
        doca_third_party_json_object_object_add(object_property, "type", doca_third_party_json_object_new_string("object"));
        ...
        doca_third_party_json_object_object_add(nested_property, "type", doca_third_party_json_object_new_string("string"));
        ...
        doca_third_party_json_object_object_add(array_property, "type", doca_third_party_json_object_new_string("array"));
        doca_third_party_json_object_object_add(array_property, "title", doca_third_party_json_object_new_string("Array Property"));
        doca_third_party_json_object_object_add(array_property, "description",
                               doca_third_party_json_object_new_string("An array property"));
        json_object *items = doca_third_party_json_object_new_object();
        doca_third_party_json_object_object_add(items, "type", doca_third_party_json_object_new_string("string"));
        doca_third_party_json_object_object_add(array_property, "items", items);
        doca_third_party_json_object_object_add(array_property, "default", doca_third_party_json_object_new_array());
    }
...
TEST_F(schema_analyzer_test, analyze_property_with_constraints)
{
    ...
    doca_third_party_json_object_object_add(constrained_property, "type", doca_third_party_json_object_new_string("integer"));
    doca_third_party_json_object_object_add(constrained_property, "minimum", doca_third_party_json_object_new_int(0));
    doca_third_party_json_object_object_add(constrained_property, "maximum", doca_third_party_json_object_new_int(100));
    doca_third_party_json_object_object_add(constrained_property, "default", doca_third_party_json_object_new_int(50));
    doca_third_party_json_object_object_add(constrained_property, "title",
                           doca_third_party_json_object_new_string("Constrained Property"));
    doca_third_party_json_object_object_add(constrained_property, "description",
